...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    public void OnStartGameButtonClicked()
    {
        ...
        {
             if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsValue("dr")) //death race mode
            {
                PhotonNetwork.LoadLevel("MarsRumbleScene");
            }
        }
    }
    ...
    public override void OnJoinRandomFailed(short returnCode, string message)
    {
        ...
        if (GameMode != null)
        {
            string roomName = RoomNameInputField.text; // if no name it will not allow you to make
            ...
            RoomOptions roomOptions = new RoomOptions();
            roomOptions.MaxPlayers = 3;
            string[] roomPropertiesInLobby = { "gm" }; //GM means Game Mode

            //RC Racing DC DeathRace
